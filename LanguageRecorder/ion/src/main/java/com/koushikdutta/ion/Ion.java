...
public class Ion {
     ...
     * @return
     */
    public IonRequestBuilder build(Context context) {
     ...
     * @return
     */
    public IonRequestBuilder build(Fragment fragment) {
     ...
     * @return
     */
    public IonRequestBuilder build(android.support.v4.app.Fragment fragment) {
